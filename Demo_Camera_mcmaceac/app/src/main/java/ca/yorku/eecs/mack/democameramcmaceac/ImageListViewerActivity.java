...
public class ImageListViewerActivity extends ListActivity
{
	...
	final static String IMAGE_INDEX_KEY = DemoCameramcmaceacActivity.IMAGE_INDEX_KEY;
	final static String DIRECTORY_KEY = DemoCameramcmaceacActivity.DIRECTORY_KEY;
	final static String IMAGE_FILENAMES_KEY = DemoCameramcmaceacActivity.IMAGE_FILENAMES_KEY;
